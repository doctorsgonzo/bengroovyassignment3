...
class AuthenticationService {
	...
	*/
    private static defaultEventHandlers = [
        ...
        onSaveUser: { user -> user.createdDate = new Date(); user.save() },
        ...
        onCheckAuthorized: { params -> (params.controllerName == "customer" || (params.controllerName == "listing" && params.actionName == "create")    ) && params.user.admin == false ? false : true },        // Called after a denied access
